...
стилей, то, если контейнер изображения станет уже ширины изображения, 
...
100-килобайтную картинку размером 990х300 пикселей, предназначенную для
...
Такую проблему мы называем проблемой «контроля контекста». Некоторые
...
отстаивает подход «сначала мобильные» и выступает за отзывчивые сайты,
которые не возлагают на мобильных пользователей неподъемную ношу. Его скрипт
...
специальной разметки*, в которой спаны представляют собой варианты изображений,
...
формировать ее на лету согласно той конфигурации, которую вы напишете, и будет
отдавать изображения на страницы автоматически. В скрипте есть много настраиваемых опций,
...
Вы, вероятно, заметили, что все решения, перечисленные выше требовали JavaScript, а некоторые
...
Вы вводите URL вашего сайта, проводите тест на скорость из выбранного места и
...
другие запросы, и так далее. Результаты приходят в виде таблиц, графиков,
...
"[Отзывчивый и ответственный][26]" на An Event Apart в Атланте.
* Джордан Мур написал превосходную статью, которая глубже рассматривает [соображения
ответственности в отзывчивом дизайне][27].
* Вы запутались и ничего не понимаете? Все нормально, мы пытаемся понять эту штуку — отзывчивый дизайн — все
вместе. Джош Лонг призывает нас всех собраться и поделиться опытом в статье:
"[Понятия не имею, что я творю, когда делаю отзывчивый дизайн][28]".
* Хотите пойти еще дальше? Включайтесь! Объедините силы с ребятами в [группе сообщества
