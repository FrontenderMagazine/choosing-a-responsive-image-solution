...
ваш логотип находится внутри елемента, у которого стоит класс `branding`. В таком
...
ситуаций — лабо изменять изображение на лету.
...
другом месте (например, на CDN), ничего небудет работать.
